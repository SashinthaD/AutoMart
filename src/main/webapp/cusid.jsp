...
<!--Open Content Area-->
<div class="form">
<form action="confirmcidServlet" method="post">
			
<label for="cid"><strong>Please Enter Your customer ID :</strong></label><br><br>
  <br>
  <br>
<input type="number" id="cid" pattern ="[0-9]{1,}" name="cid" value="<%=id%>"><br><br>
