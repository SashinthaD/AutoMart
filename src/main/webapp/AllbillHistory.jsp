...
<link href="https://fonts.googleapis.com/css2?family=Quicksand:wght@500&display=swap" rel="stylesheet">
	<link rel="stylesheet" href="css/finance6.css">
...
<h2>Select Bill Category</h2>
    ...
    <input type ="button" class="date "onclick="document.location = 'RepairDate.jsp'" value="Repair Bill History">
    
    <input type ="button" class="date "onclick="document.location = 'DeliveryDate.jsp'" value="Delivery Bill History">
