...
<head>
	...
	<link rel="stylesheet" href="css/profileUpdateNew.css">
</head>
...
<!--Open Content Area-->
        ...
        <form name="form" class="form" method="post" action="profileUpdateNew">
        
      		<h2>Enter new position</h2><br><br><br><br><br>
			
			<input type="text" name="newposition" id="newposition" required> <br><br><br><br><br>
				
			<button type="submit" id="add" name="add" value="Add new"> Add new </button> <br><br>
        </form>
