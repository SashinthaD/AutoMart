...
<!--Open Content Area-->
<div class="form">
<form action="DeliveryBillHistory" method="post">
			
<label for="cid"><strong>Enter Delivery Bill Date :</strong></label><br><br>
  <br>
  <br>
 		...
 		<input type="date" id="rid" name="deliverydate" ><br><br>
	 	
         <input type ="submit" id="submit" value=" Show Bill History">
