...
String sql="Select * from stock where less_item>=30" ;
...
Class.forName("com.mysql.jdbc.Driver").newInstance();
Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/automart","root","Malshi1999");
String sql="Select * from stock where less_item BETWEEN 1 AND 29" ;
Statement st=con.createStatement();
ResultSet rs=st.executeQuery(sql);
while(rs.next()){
...
Class.forName("com.mysql.jdbc.Driver").newInstance();
Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/automart","root","Malshi1999");
String sql="Select * from stock where qty=50 and limit_stock=50 ";
