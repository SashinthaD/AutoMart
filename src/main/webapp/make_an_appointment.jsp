...
<head>
	...
	<link rel="stylesheet" href="css/make_an_appointment.css">
...
<div class="form">
<form action="Appointmentinsert" method="post">
			
<label for="cid"><strong><h2> Make An Appointment </h2></strong></label><br><br><br> <br> 
...
&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp 
 <select id="type" name="model" class="input" required>
	<option>--</option>
 ...
 <select id="type" name="time" class="input" required>
	<option>--</option>
...
<br> 
 ...
 <input type="date" id="date" name="date" input="date" class="input" required><br><br>




 <label class="label">Enter Your CID:</label>
 &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
 <input type = "text" class="input" id="cid" name = "cid"  required><br><br>
