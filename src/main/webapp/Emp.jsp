...
<head>
	...
	<title>Enter Deliver Repair ID</title>
...
<label for="cid"><strong>Employee Details :</strong></label><br><br>
  <br>
  <br>
	  ...
	  <input type="submit" id="submit" name="Submit" value="Show Employee List"><br><br>
