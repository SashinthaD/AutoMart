...
<!--Open Content Area-->
<form name="myForm" action="DeleteStockServlet" onsubmit="return validateForm()" method="post" >

<%


 Class.forName("com.mysql.jdbc.Driver").newInstance();
Connection conn=DriverManager.getConnection("jdbc:mysql://localhost:3306/automart","root","Malshi1999");
    ...
    <th><h3>Status</h3></th> <th><select name="status" id="status">
			<option  value="<%=rs.getString(11)%>" ><%=rs.getString(11)%>  </option>
 				 <option value="stock is full">stock is full</option>
  				 <option value="stock is not full">stock is not full</option>
