...
<br>
<br>
		<h2>Search Deliver</h2><br><br>	

<form action="DeliverSearchServlet" method="post">

<lable>Deliver ID :</lable>
<input type="text" name="d_id" required><br><br><br>
