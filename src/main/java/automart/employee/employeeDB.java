...
public class employeeDB {
	...
	public static boolean insertEmployeeDetails(String nic, String name, String position, String salary, String password, String section, String email ) {
		...
		try {
			...
			String sql = "insert into new_employee values ('"+nic+"', '"+name+"', '"+email+"', NULL, '"+position+"', NULL, '"+sal+"', '"+section+"', '"+password+"')";
	...
	public static boolean updateProfile(String name, String mobile, String email, String dob, String nic) {
		...
		try {
			...
			String sql = "update new_employee set name='"+name+"', email='"+email+"', mobile='"+mob+"', DOB='"+dob+"' where Nic='"+nic+"'";
	...
	public static boolean profileChange(String position, String basicSalary, String section, String nic) {
		...
		try {
			...
			String sql = "update new_employee set position='"+position+"', Basic_salary='"+salary+"', section='"+section+"' where Nic='"+nic+"'";
	...
	public static boolean deleteProfile(String nic) {
		...
		try {
			...
			String sql = "delete from new_employee where Nic='"+nic+"'";
	...
	public static boolean previousEmployee(String nic, String name, String email, String mobile, String position, String dob, String date) {
		...
		try {
			...
			String sql = "insert into pervious_employee values ('"+nic+"', '"+name+"', '"+email+"', '"+mob+"', '"+position+"', '"+dob+"', '"+date+"')";
	...
	public static boolean insertLeaving(String nic, String reason, String days, String date, String more, String status) {
		...
		try {
			...
			String sql = "insert into leaving values (0,'"+reason+"','"+Days+"','"+date+"','"+more+"','"+status+"','"+nic+"')";
	...
	public static List<leaveApply> leavingAppDetails(String nic) {
		...
		try {
			...
			if (rs.next()) {
				...
				leaveApply e = new leaveApply (id, reason, period, date, status, Nic);
				app.add(e);
			}
		}
		catch (Exception e) {
	...
	public static void sendEmail(String host, String port, String user, String pass, String email, String subject, String content) throws AddressException, MessagingException {
		pro = new Properties();
